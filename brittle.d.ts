/**
 * Type declarations for brittle test framework.
 * Extends @types/brittle to include hook() which is exported at runtime
 * but missing from the community type definitions.
 */
